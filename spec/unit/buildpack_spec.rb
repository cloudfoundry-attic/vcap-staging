...
describe "Buildpack Plugin" do
  describe "when dealing with weird bundler path issues" do
    it "must be using bundler 1.2.2" do
      `bundle -v`.should include("1.2.2") # See /buildpacks/ruby/lib/language_pack/ruby.rb:11
    end
  end
