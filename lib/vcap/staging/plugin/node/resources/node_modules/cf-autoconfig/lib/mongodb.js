    ...
    "mongodb" : function (moduleData, props) {
      ...
      if ("connect" in moduleData) {
        ...
        moduleData.connect = function () {
          if (arguments.length > 2) {
            return oldConnect.call(this, props.url, arguments[1], arguments[2]);
          }
          else if (arguments.length === 2) {
            return oldConnect.call(this, props.url, arguments[1]);
          }
          else {
            return oldConnect.call(this, props.url);
          }
        };
      ...
      if ("Server" in moduleData) {
        ...
        moduleData.Server = function () {
          return oldServer.call(this, props.host, parseInt(props.port, 10), arguments[1]);
        };
      ...
      if ("Db" in moduleData) {
        ...
        moduleData.Db = function () {
          var self = function () {
            if (arguments.length > 2) {
              return oldDb.call(this, props.db, arguments[1], arguments[2]);
            }
            else if (arguments.length == 2) {
              return oldDb.call(this, props.db, arguments[1]);
            }
            else {
              return oldDb.call(this, props.db);
            }
          };
        ...
        if ("authenticate" in moduleData.Db.prototype) {
          ...
          moduleData.Db.prototype.authenticate = function () {
            return oldAuthenticate.call(this, props.username, props.password, arguments[2]);
          };
        }
      ...
      if ("Connection" in moduleData && "open" in moduleData.Connection.prototype) {
        ...
        moduleData.Connection.prototype.open = function () {
          ...
          if (originalOptions !== null) {
            ...
            if (originalOptions.hasOwnProperty("server"))
              options.server = originalOptions.server;
            if (originalOptions.hasOwnProperty("replset"))
              options.replset = originalOptions.replset;
