...
class GemfileTask
  ...
  def bundle_definition
    ...
    begin
      ...
      @logger.error "Error installing gems. You may have an invalid :path in your Gemfile: #{e}"
      raise "Error installing gems. This is likely due to an invalid :path in Gemfile: #{e}"
    rescue Bundler::GemfileError => e
      @logger.error "Error parsing Gemfile. You may be using a method incompatible with Bundler version #{Bundler::VERSION}: #{e}"
