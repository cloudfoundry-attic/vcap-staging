...
require File.expand_path('../gem_spec', __FILE__)
...
class GemfileTask
      ...
      begin
        ...
        gemspecs.each do |gemspec_path|
          ...
          if gemspec.requires_build?
            ...
            copy_dir_contents(installed_gem_dir, gemspec.base)
  ...
  def compile_gem(gemfile_path)
    ...
    run_secure?(staging_cmd, tmp_dir) ? gem_install_dir : nil
  end
end
